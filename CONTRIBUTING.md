...
Add a subdirectory tree to **~/.novx/locale**, and place *nv_collection.mo* there, like this:
...
*nv_collection* depends on the [novxlib](https://github.com/peter88213/novxlib) and [collectionnv](https://github.com/peter88213/collectionnv) libraries which must be present in your file system. It is organized as an Eclipse PyDev project. The official release branch on GitHub is *main*.
