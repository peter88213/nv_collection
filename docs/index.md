...
[Download the latest release (version 1.0.1)](https://github.com/peter88213/noveltree_collection/raw/main/dist/nv_collection_v1.0.1.zip)

- Extract the "nv_collection_v1.0.1" folder from the downloaded zipfile "nv_collection_v1.0.1.zip".
