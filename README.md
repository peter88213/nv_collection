[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_collection/raw/main/dist/nv_collection_v5.6.1.pyz)
...
Download the latest release [nv_collection_v5.6.1.pyz](https://github.com/peter88213/nv_collection/raw/main/dist/nv_collection_v5.6.1.pyz) (28 KB)

- Launch *nv_collection_v5.6.1.pyz* by double-clicking (Windows desktop),
- or execute `python nv_collection_v5.6.1.pyz` (Windows), resp. `python3 nv_collection_v5.6.1.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_collection_v5.6.1.zip](https://github.com/peter88213/nv_collection/raw/main/dist/nv_collection_v5.6.1.zip) (28 KB)

- Extract the *nv_collection_v5.6.1* folder from the downloaded zipfile "nv_collection_v5.6.1.zip".
